...
const VARIANTS = {
    ...
    "v2v": [{ value: "none", text: "none" },
            { value: "storyboard (v2v)", text: "storyboard — 3 camera angles" },
            { value: "edit (v2v)", text: "edit — add/remove/change elements" }],
    "t2v": [{ value: "none", text: "none" },
            ...
            { value: "split (t2v)", text: "split — multi-camera synchronized split-screen" }],
